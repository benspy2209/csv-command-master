...
const Index = () => {
  ...
  // Réinitialiser les données au chargement de la page à l'aide de useEffect (pas useState)
  useEffect(() => {
    // Décommenter la ligne suivante si vous voulez effacer les données au chargement de la page
    // clearAllData();
  }, []);
